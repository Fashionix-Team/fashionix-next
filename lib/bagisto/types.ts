...
// Product Detail Form Types
export interface ProductSuperAttribute {
  id: string;
  code: string;
  adminName: string;
  type: string;
  position: number;
  isFilterable: boolean;
  options: ProductSuperAttributeOption[];
}

export interface ProductSuperAttributeOption {
  id: string;
  adminName: string;
...
export interface ProductDetailFormProps {
  product: {
    ...
    superAttributes?: ProductSuperAttribute[];
    inventories?: {
      qty: number;
    }[];
    priceHtml?: {
